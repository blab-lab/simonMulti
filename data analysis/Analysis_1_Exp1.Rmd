...
data12$F1_Sign <- ifelse(data12$Direction == "Upshift", 
                         (data12$F1_Change * -1), 
                         data12$F1_Change)

#Plot check

temp1 <- summarySEwithin(data = data12, 
                         measurevar = "F1_Sign",
...
data12$Direction <- factor(data12$Direction, levels = c("Upshift", "Downshift"))

contrasts(data12$Direction) = contr.sum(2)

contrasts(data12$Direction)

data12$Phase <- factor(data12$Phase, levels = c("Hold", "Washout"))

contrasts(data12$Phase) = contr.sum(2)

contrasts(data12$Phase)
...
car::Anova(m1.a, type = 3)

testInteractions(m1.a, 
                 fixed = NULL, 
                 pairwise = c("Word"))
...
temp1 <- data12[which(data12$Word == "head"), "F1_Sign"]
temp2 <- data12[which(data12$Word == "bed"), "F1_Sign"]
temp3 <- data12[which(data12$Word == "ted"), "F1_Sign"]
