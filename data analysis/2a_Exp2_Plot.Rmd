...
data2$Lexical <- ifelse(data2$Word == "seven", log10(0.0066426182/100), 
                        ifelse(data2$Word == "sever", log(0.0001058289/100), log(0.0225605090/100)))
...
ggsave(filename = "H:/Shared drives/SMNG/Experiments/simonMultisyllable/Manuscript/PlotGen/2B.png",
       plot = last_plot(), 
       dpi = 600,
       width = 9,
       height = 4)
...
ggsave(filename = "H:/Shared drives/SMNG/Experiments/simonMultisyllable/Manuscript/PlotGen/2A.png",
       plot = last_plot(), 
       dpi = 600,
       width = 9,
       height = 1.5)
...
ggsave(filename = "H:/Shared drives/SMNG/Experiments/simonMultisyllable/Manuscript/PlotGen/2C.png",
       plot = last_plot(), 
       dpi = 600,
       width = 9,
       height = 2)
...
ggsave(filename = "H:/Shared drives/SMNG/Experiments/simonMultisyllable/Manuscript/PlotGen/2D.png",
       plot = last_plot(), 
       dpi = 600,
       width = 9,
       height = 4)
