...
data3$Lexical <- ifelse(data3$Word == "seven", log10(0.0065751348/100), 
                        ifelse(data3$Word == "sever", log(0.0001091837/100), log(0.0218708061/100)))
...
data31 <- data3[which(data3$Chunk %in% c(13, 16)), ]
